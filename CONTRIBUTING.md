...
- **No text in code.** Every user-facing string goes through the stringtable.
  ...
  Latin I because no Metron font of the game draws U+0406.
...
- **Generated layouts are never hand-edited.** Edit the description under
  `ui/` and regenerate with `layout_build` of dayz-agentic-modding-mcp; the
  gallery is looked at in two sizes and in both languages.
